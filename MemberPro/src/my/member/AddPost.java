...
@WebServlet("/addPost")
public class AddPost extends HttpServlet{ //add PostDTO to post database
	@Override
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		dao.writePost(dto); //import PostDTO data to post database
		
		resp.sendRedirect("member/logOn_sub.jsp"); //goto logOn_sub.jsp
	}
}
